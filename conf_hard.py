# -*- coding: utf-8 -*-
#
# Learn Ruby The Hard Way documentation build configuration file, created by
...
latex_documents = [
  ('index', 'LearnMongoDBAndNodeJsTheHardWay.tex', u'Learn MongoDB And Node.js The Hard Way',
